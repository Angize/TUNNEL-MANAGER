...
بکاپ و بازگردانی از صفحهٔ **تنظیمات ← بکاپ** است: «دانلودِ بکاپ» همهٔ دادهٔ پنل را با کلیدِ امضا در یک
فایل می‌دهد؛ «انتخابِ فایل» اول فایل را بررسی می‌کند و نشان می‌دهد چه چیزی عوض می‌شود، و فقط با تأیید
جایگزین می‌کند و پنل را دوباره راه می‌اندازد. برای بردنِ پنل به سرورِ دیگر، روی سرورِ تازه `--install` بزن
و همان‌جا بکاپ را بازگردانی کن — بعد پنلِ قبلی را خاموش کن.
